...
export BIN_DIR="${XDG_BIN_HOME:-$HOME/.local/bin}/dotfiles"

export SETUP_DATA_DIR="${DATA_DIR}/setup"
export SETUP_CONFIG_DIR="${CONFIG_DIR}/setup"
export SETUP_SCRIPT_DIR="${BIN_DIR}/setup.d"
