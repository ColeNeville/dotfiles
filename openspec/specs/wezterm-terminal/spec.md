# Capability: wezterm-terminal

## Purpose

Define the modular override system for wezterm terminal emulator configuration, allowing packages to contribute settings through an `overrides.d/` directory.
